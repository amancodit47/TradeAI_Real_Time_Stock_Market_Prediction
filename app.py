...
st.set_page_config(page_title="TradeAI App", layout="wide")
...
def login_page():
    ...
    st.markdown("<h2 class='login-title'>🔒 TradeAI App Login</h2>", unsafe_allow_html=True)
...
if "page" not in st.session_state:
    st.session_state.page = "📊 TradeAI Dashboard"
